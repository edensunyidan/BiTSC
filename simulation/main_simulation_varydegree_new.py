...
if __name__ == "__main__":
    ...
    print(output_sp['rand_index'])
    print(output_hc['rand_index'])
    print(output_bitkmeans['rand_index'])
    """
    ##################### vary average degree #####################
    #noise_ratio = 0.1
    #noise_ratio = 0.3
    ...
    for q in q_list:
        ...
        output = dict(expect_degree=data.expected_lambda, average_degree=data.average_degree, sp=output_sp, tsc_hc=output_tsc_hc, tscu_hc=output_tscu_hc, sp_tsc_hc=output_sp_tsc_hc)
        nokernel_degree_list.append(output)
    
    print("nokernel_degree_list is getting calculated")
    ...
    result = dict(withkernel = withkernel_degree_list, nokernel = nokernel_degree_list)
    #print(result)
    root_dir = '/home/yidan/Dropbox/project_fly_worm/simulation/result/data'
    with open(root_dir + '/analysis_varydegree_new.json', 'w') as f:
        json.dump(result, f)
