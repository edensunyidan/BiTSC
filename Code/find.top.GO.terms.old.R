find.top.GO.terms <-
  function(gene_lists, all_genes, GOmappingfile, output_file, 
    ...
    #system.file("filename", package = "base")
    ...
    ###the following step take the subset of GO annotations to only keep BP
    ...
    #Do we have to check and update whether any genes are removed after we filter GO terms
    #all_genes_w_GO <- names(sp_geneID2GO)
